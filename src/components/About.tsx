        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
          ...
          >
            <div className="relative aspect-square max-w-md mx-auto">
              ...
              {/* Center content */}
              <div className="absolute inset-16 rounded-full bg-gold-gradient flex items-center justify-center">
                <div className="text-center">
                  <div className="text-navy-dark font-display text-4xl font-bold">15+</div>
