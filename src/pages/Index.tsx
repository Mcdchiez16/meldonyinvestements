      ...
      <section className="section-padding bg-navy/30">
        <div className="container-wide">
          ...
          >
            <Link
              to="/divisions"
              className="inline-flex items-center gap-2 px-8 py-4 border border-border text-foreground font-medium rounded-lg hover:border-accent/50 hover:text-accent transition-all duration-300"
            >
              View All Divisions
            ...
            <div className="relative z-10 p-10 md:p-16 lg:p-20">
              <div className="max-w-3xl mx-auto text-center">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                  ...
                  <Link
                    to="/projects"
                    className="px-8 py-4 border border-border text-foreground font-medium rounded-lg hover:border-accent/50 hover:text-accent transition-all duration-300"
                  >
                    View Our Projects
                  </Link>
                </div>
